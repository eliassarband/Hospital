    ...
    public class HospitalContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
			...
			modelBuilder.Entity<FormCategory>().HasData(
				...
				new FormCategory() { Id = 3, Code = "OPDIPD", Name = "OPD / IPD", ShowInDashboard = true, Priority = 3 },
            ...
            modelBuilder.Entity<Form>().HasData(
                ...
                new Form() { Id = 103, FormCategoryId = 1, Code = "OPDIPD", Name = "OPD/IPD", ShowInMenu = true, Priority = 3, Url = "OPDIPDDashboard" },
				...
				new Form() { Id = 302, FormCategoryId = 3, Code = "PatientDefine", Name = "Patinet Define", ShowInMenu = false, Priority = 2, Url = "PatientDefine" },
				...
				new Form() { Id = 307, FormCategoryId = 3, Code = "IPDRegisterations", Name = "Admited Patinet List", ShowInMenu = true, Priority = 7, Url = "IPDRegisterations" },
				new Form() { Id = 308, FormCategoryId = 3, Code = "IPDRegisterationDefine", Name = "IPD Registeration", ShowInMenu = true, Priority = 8, Url = "IPDRegisterationDefine" },
                ...
                new Form() { Id = 1006, FormCategoryId = 10, Code = "DailyReport", Name = "Daily Report", ShowInMenu = true, Priority = 6, Url = "DailyReport" },
                new Form() { Id = 1007, FormCategoryId = 10, Code = "DepartmentWiseReport", Name = "Department Wise Report", ShowInMenu = true, Priority = 7, Url = "DepartmentWiseReport" },
                ...
                new Form() { Id = 1133, FormCategoryId = 11, Code = "FreeBed", Name = "Free Bed", ShowInMenu = false, Priority = 33, Url = "FreeBed" },
            ...
            modelBuilder.Entity<FormAction>().HasData(
                ...
                new FormAction() { Id = 10302, FormId = 103, Code = "Show", Name = "Show", Priority = 2 },
                new FormAction() { Id = 10303, FormId = 103, Code = "Reset", Name = "Reset", Priority = 3 },
                new FormAction() { Id = 10304, FormId = 103, Code = "Edit", Name = "Edit", Priority = 4 },
                new FormAction() { Id = 10305, FormId = 103, Code = "Cancel", Name = "Cancel", Priority = 5 },
                new FormAction() { Id = 10306, FormId = 103, Code = "Print", Name = "Print", Priority = 6 },
                new FormAction() { Id = 10307, FormId = 103, Code = "Discharge", Name = "Discharge", Priority = 7 },
                ...
                new FormAction() { Id = 30701, FormId = 307, Code = "View", Name = "View", Priority = 1 },
                new FormAction() { Id = 30702, FormId = 307, Code = "Add", Name = "Add", Priority = 2 },
                new FormAction() { Id = 30703, FormId = 307, Code = "Edit", Name = "Edit", Priority = 3 },
                new FormAction() { Id = 30704, FormId = 307, Code = "Cancel", Name = "Cancel", Priority = 4 },
                new FormAction() { Id = 30705, FormId = 307, Code = "Discharge", Name = "Discharge", Priority = 5 },
                new FormAction() { Id = 30706, FormId = 307, Code = "Print", Name = "Print", Priority = 6 },

                new FormAction() { Id = 30801, FormId = 308, Code = "View", Name = "View", Priority = 1 },
                new FormAction() { Id = 30802, FormId = 308, Code = "Save", Name = "Save", Priority = 2 },
                new FormAction() { Id = 30803, FormId = 308, Code = "Print", Name = "Print", Priority = 3 },
                new FormAction() { Id = 30804, FormId = 308, Code = "AddPatient", Name = "Add Patient", Priority = 4 },
                new FormAction() { Id = 30805, FormId = 308, Code = "SearchPatient", Name = "Search Patient", Priority = 5 },
                new FormAction() { Id = 30806, FormId = 308, Code = "SearchOPD", Name = "Search OPD Billing", Priority = 6 },
                new FormAction() { Id = 30807, FormId = 308, Code = "AddRoom", Name = "Add Room", Priority = 7 },
                new FormAction() { Id = 30808, FormId = 308, Code = "DeleteRoom", Name = "Delete Room", Priority = 8 },
                new FormAction() { Id = 30809, FormId = 308, Code = "AddService", Name = "Add Service", Priority = 9 },
                new FormAction() { Id = 30810, FormId = 308, Code = "DeleteService", Name = "Delete Service", Priority = 10 },
                new FormAction() { Id = 30811, FormId = 308, Code = "AddPayment", Name = "Add Payment", Priority = 11 },
                new FormAction() { Id = 30812, FormId = 308, Code = "DeletePayment", Name = "Delete Payment", Priority = 12 },
                new FormAction() { Id = 30813, FormId = 308, Code = "PrintPayment", Name = "Print Payment", Priority = 13 },
                new FormAction() { Id = 30814, FormId = 308, Code = "SelectBed", Name = "Select Bed", Priority = 14 },
                ...
                new FormAction() { Id = 100601, FormId = 1006, Code = "View", Name = "View", Priority = 1 },

                new FormAction() { Id = 100701, FormId = 1007, Code = "View", Name = "View", Priority = 1 },
                ...
                new FormAction() { Id = 113301, FormId = 1133, Code = "View", Name = "View", Priority = 1 },
