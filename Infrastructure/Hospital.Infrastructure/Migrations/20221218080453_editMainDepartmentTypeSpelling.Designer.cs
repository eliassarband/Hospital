...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20221218080453_editMainDepartmentTypeSpelling")]
    partial class editMainDepartmentTypeSpelling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Super",
                            CreatedDate = new DateTime(2022, 12, 18, 11, 34, 53, 137, DateTimeKind.Local).AddTicks(1044),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 18, 11, 34, 53, 137, DateTimeKind.Local).AddTicks(993),
                            Name = "Super Admin"
                        },
                        new
                        {
                            Id = 2,
                            Code = "Admin",
                            CreatedDate = new DateTime(2022, 12, 18, 11, 34, 53, 137, DateTimeKind.Local).AddTicks(1047),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 18, 11, 34, 53, 137, DateTimeKind.Local).AddTicks(1045),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = 3,
                            Code = "Operator",
                            CreatedDate = new DateTime(2022, 12, 18, 11, 34, 53, 137, DateTimeKind.Local).AddTicks(1050),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 18, 11, 34, 53, 137, DateTimeKind.Local).AddTicks(1049),
                            Name = "Operator"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 18, 11, 34, 53, 138, DateTimeKind.Local).AddTicks(7478),
                            CreatedUser = "elias.sarband",
                            Email = "elias.sarband@gmail.com",
                            FirstName = "Elias",
                            LastName = "Sarband",
                            ModifiedDate = new DateTime(2022, 12, 18, 11, 34, 53, 137, DateTimeKind.Local).AddTicks(1165),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 12, 18, 11, 34, 53, 138, DateTimeKind.Local).AddTicks(7528),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 18, 11, 34, 53, 138, DateTimeKind.Local).AddTicks(7522),
                            RoleId = 1,
                            UserId = 1
                        });
                });
