...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20221219093026_addInsuranceAgreement")]
    partial class addInsuranceAgreement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.BasicInformationCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "StaffType",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1026),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1022),
                            Name = "Staff Type",
                            Viewable = true
                        },
                        new
                        {
                            Id = 2,
                            Code = "NamePrefix",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1029),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1027),
                            Name = "Name Prefix",
                            Viewable = true
                        },
                        new
                        {
                            Id = 3,
                            Code = "Speciality",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1031),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1030),
                            Name = "Speciality",
                            Viewable = true
                        },
                        new
                        {
                            Id = 4,
                            Code = "Qualification",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1034),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1033),
                            Name = "Qualification",
                            Viewable = true
                        },
                        new
                        {
                            Id = 5,
                            Code = "City",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1036),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1035),
                            Name = "City",
                            Viewable = true
                        },
                        new
                        {
                            Id = 6,
                            Code = "Area",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1039),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1038),
                            Name = "Area",
                            RelatedCategoryId = 5,
                            Viewable = true
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1042),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1040),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Super",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 158, DateTimeKind.Local).AddTicks(3236),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 158, DateTimeKind.Local).AddTicks(3184),
                            Name = "Super Admin"
                        },
                        new
                        {
                            Id = 2,
                            Code = "Admin",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 158, DateTimeKind.Local).AddTicks(3239),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 158, DateTimeKind.Local).AddTicks(3237),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = 3,
                            Code = "Operator",
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 158, DateTimeKind.Local).AddTicks(3242),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 158, DateTimeKind.Local).AddTicks(3240),
                            Name = "Operator"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 159, DateTimeKind.Local).AddTicks(2665),
                            CreatedUser = "elias.sarband",
                            Email = "elias.sarband@gmail.com",
                            FirstName = "Elias",
                            LastName = "Sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 158, DateTimeKind.Local).AddTicks(3380),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(953),
                            CreatedUser = "elias.sarband",
                            Email = "",
                            FirstName = "Admin",
                            LastName = "AccurateCo",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 159, DateTimeKind.Local).AddTicks(2675),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1002),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1000),
                            RoleId = 1,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1005),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 13, 0, 26, 160, DateTimeKind.Local).AddTicks(1004),
                            RoleId = 1,
                            UserId = 2
                        });
                });
