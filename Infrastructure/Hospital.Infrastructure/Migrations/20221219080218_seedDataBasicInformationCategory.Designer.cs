...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20221219080218_seedDataBasicInformationCategory")]
    partial class seedDataBasicInformationCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.BasicInformationCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "StaffType",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7713),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7709),
                            Name = "Staff Type",
                            Viewable = false
                        },
                        new
                        {
                            Id = 2,
                            Code = "NamePrefix",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7716),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7714),
                            Name = "Name Prefix",
                            Viewable = false
                        },
                        new
                        {
                            Id = 3,
                            Code = "Speciality",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7719),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7717),
                            Name = "Speciality",
                            Viewable = true
                        },
                        new
                        {
                            Id = 4,
                            Code = "Qualification",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7721),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7720),
                            Name = "Qualification",
                            Viewable = false
                        },
                        new
                        {
                            Id = 5,
                            Code = "City",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7724),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7723),
                            Name = "City",
                            RelatedCategoryId = 5,
                            Viewable = false
                        },
                        new
                        {
                            Id = 6,
                            Code = "Area",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7727),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7726),
                            Name = "Area",
                            Viewable = false
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Super",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 210, DateTimeKind.Local).AddTicks(902),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 210, DateTimeKind.Local).AddTicks(836),
                            Name = "Super Admin"
                        },
                        new
                        {
                            Id = 2,
                            Code = "Admin",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 210, DateTimeKind.Local).AddTicks(908),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 210, DateTimeKind.Local).AddTicks(906),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = 3,
                            Code = "Operator",
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 210, DateTimeKind.Local).AddTicks(912),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 210, DateTimeKind.Local).AddTicks(910),
                            Name = "Operator"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 211, DateTimeKind.Local).AddTicks(8361),
                            CreatedUser = "elias.sarband",
                            Email = "elias.sarband@gmail.com",
                            FirstName = "Elias",
                            LastName = "Sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 210, DateTimeKind.Local).AddTicks(1111),
                        ...
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7565),
                            CreatedUser = "elias.sarband",
                            Email = "",
                            FirstName = "Admin",
                            LastName = "AccurateCo",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 211, DateTimeKind.Local).AddTicks(8385),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7686),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7684),
                            RoleId = 1,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7689),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 19, 11, 32, 18, 212, DateTimeKind.Local).AddTicks(7687),
                            RoleId = 1,
                            UserId = 2
                        });
                });
