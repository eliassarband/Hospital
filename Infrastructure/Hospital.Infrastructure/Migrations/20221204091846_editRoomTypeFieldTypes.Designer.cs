...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20221204091846_editRoomTypeFieldTypes")]
    partial class editRoomTypeFieldTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Super",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 48, 46, 495, DateTimeKind.Local).AddTicks(4970),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 48, 46, 495, DateTimeKind.Local).AddTicks(4908),
                            Name = "Super Admin"
                        },
                        new
                        {
                            Id = 2,
                            Code = "Admin",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 48, 46, 495, DateTimeKind.Local).AddTicks(4974),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 48, 46, 495, DateTimeKind.Local).AddTicks(4972),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = 3,
                            Code = "Operator",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 48, 46, 495, DateTimeKind.Local).AddTicks(4978),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 48, 46, 495, DateTimeKind.Local).AddTicks(4976),
                            Name = "Operator"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 48, 46, 496, DateTimeKind.Local).AddTicks(6309),
                            CreatedUser = "elias.sarband",
                            Email = "elias.sarband@gmail.com",
                            FirstName = "Elias",
                            LastName = "Sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 48, 46, 495, DateTimeKind.Local).AddTicks(5134),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 48, 46, 496, DateTimeKind.Local).AddTicks(6358),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 48, 46, 496, DateTimeKind.Local).AddTicks(6355),
                            RoleId = 1,
                            UserId = 1
                        });
                });
