...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20221204092437_addRoom")]
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Super",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 54, 36, 939, DateTimeKind.Local).AddTicks(6016),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 54, 36, 939, DateTimeKind.Local).AddTicks(5967),
                            Name = "Super Admin"
                        },
                        new
                        {
                            Id = 2,
                            Code = "Admin",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 54, 36, 939, DateTimeKind.Local).AddTicks(6020),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 54, 36, 939, DateTimeKind.Local).AddTicks(6018),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = 3,
                            Code = "Operator",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 54, 36, 939, DateTimeKind.Local).AddTicks(6023),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 54, 36, 939, DateTimeKind.Local).AddTicks(6021),
                            Name = "Operator"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 54, 36, 940, DateTimeKind.Local).AddTicks(6686),
                            CreatedUser = "elias.sarband",
                            Email = "elias.sarband@gmail.com",
                            FirstName = "Elias",
                            LastName = "Sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 54, 36, 939, DateTimeKind.Local).AddTicks(6156),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 54, 36, 940, DateTimeKind.Local).AddTicks(6735),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 54, 36, 940, DateTimeKind.Local).AddTicks(6732),
                            RoleId = 1,
                            UserId = 1
                        });
                });
