...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20221204090332_addRoomType")]
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Super",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 33, 31, 784, DateTimeKind.Local).AddTicks(1348),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 33, 31, 784, DateTimeKind.Local).AddTicks(1298),
                            Name = "Super Admin"
                        },
                        new
                        {
                            Id = 2,
                            Code = "Admin",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 33, 31, 784, DateTimeKind.Local).AddTicks(1352),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 33, 31, 784, DateTimeKind.Local).AddTicks(1350),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = 3,
                            Code = "Operator",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 33, 31, 784, DateTimeKind.Local).AddTicks(1354),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 33, 31, 784, DateTimeKind.Local).AddTicks(1353),
                            Name = "Operator"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 33, 31, 785, DateTimeKind.Local).AddTicks(1587),
                            CreatedUser = "elias.sarband",
                            Email = "elias.sarband@gmail.com",
                            FirstName = "Elias",
                            LastName = "Sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 33, 31, 784, DateTimeKind.Local).AddTicks(1474),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 33, 31, 785, DateTimeKind.Local).AddTicks(1644),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 33, 31, 785, DateTimeKind.Local).AddTicks(1641),
                            RoleId = 1,
                            UserId = 1
                        });
                });
