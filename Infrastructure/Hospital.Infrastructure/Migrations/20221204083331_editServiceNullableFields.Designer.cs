...
namespace Hospital.Infrastructure.Migrations
{
    ...
    [Migration("20221204083331_editServiceNullableFields")]
    partial class editServiceNullableFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "Super",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 3, 31, 321, DateTimeKind.Local).AddTicks(7338),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 3, 31, 321, DateTimeKind.Local).AddTicks(7285),
                            Name = "Super Admin"
                        },
                        new
                        {
                            Id = 2,
                            Code = "Admin",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 3, 31, 321, DateTimeKind.Local).AddTicks(7341),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 3, 31, 321, DateTimeKind.Local).AddTicks(7340),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = 3,
                            Code = "Operator",
                            CreatedDate = new DateTime(2022, 12, 4, 12, 3, 31, 321, DateTimeKind.Local).AddTicks(7344),
                            CreatedUser = "elias.sarband",
                            Description = "",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 3, 31, 321, DateTimeKind.Local).AddTicks(7343),
                            Name = "Operator"
                        });
                });
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 3, 31, 322, DateTimeKind.Local).AddTicks(7762),
                            CreatedUser = "elias.sarband",
                            Email = "elias.sarband@gmail.com",
                            FirstName = "Elias",
                            LastName = "Sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 3, 31, 321, DateTimeKind.Local).AddTicks(7451),
            ...
            modelBuilder.Entity("Hospital.Domain.Core.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 12, 4, 12, 3, 31, 322, DateTimeKind.Local).AddTicks(7816),
                            CreatedUser = "elias.sarband",
                            ModifiedDate = new DateTime(2022, 12, 4, 12, 3, 31, 322, DateTimeKind.Local).AddTicks(7812),
                            RoleId = 1,
                            UserId = 1
                        });
                });
