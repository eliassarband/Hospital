...
{
    public class OPDBillCommandRepository : CommandRepository<OPDBill>, IOPDBillCommandRepository
    {
        public OPDBillCommandRepository(HospitalContext context) : base(context)
        {
