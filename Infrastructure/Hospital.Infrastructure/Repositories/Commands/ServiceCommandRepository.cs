...
{
    public class ServiceCommandRepository : CommandRepository<Service>, IServiceCommandRepository
    {
        public ServiceCommandRepository(HospitalContext context) : base(context)
        {
