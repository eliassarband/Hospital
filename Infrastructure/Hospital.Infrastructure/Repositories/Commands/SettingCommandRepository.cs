...
{
    public class SettingCommandRepository : CommandRepository<Setting>, ISettingCommandRepository
    {
        public SettingCommandRepository(HospitalContext context) : base(context)
        {
